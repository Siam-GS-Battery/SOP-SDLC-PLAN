...
> **KPI Target:** >= 95% ของ changes ต้อง traceable end-to-end

---

## KPI เป้าหมายของ PR Process

| Metric | Target | วิธีวัด |
|:-------|:-------|:--------|
| **DoR Compliance** | >= 80% | % tickets ที่มีข้อมูลครบก่อนเริ่ม code |
| **DoD Compliance** | >= 80% | % PRs ที่ผ่าน DoD ครบก่อน merge |
| **Reviewed Merges** | >= 95% | % PRs ที่ผ่าน Senior review ก่อน merge |
| **Traceability** | >= 95% | % changes ที่มี Asana Task ID ใน PR |
| **PR Cycle Time** | track weekly | เวลาตั้งแต่เปิด PR → merge (baseline Q2) |
